  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        {/* Pass Card Container */}
        <div className="w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 text-white rounded-3xl p-6 shadow-2xl border border-slate-700/80 relative overflow-hidden">
          ...
          <div className="bg-white p-4 rounded-2xl shadow-inner mx-auto w-48 h-48 flex items-center justify-center relative">
          ...
          <AnimatePresence mode="wait">
            {isUnlocked ? (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="w-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-700 rounded-2xl p-4 flex items-center justify-center gap-2 font-semibold"
              >
