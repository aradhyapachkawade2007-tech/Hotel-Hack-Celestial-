...
export default function StatCard({
  ...
  return (
    <motion.div
      ...
      className={`bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-stone-200/90 dark:border-slate-800 transition-all duration-300 relative overflow-hidden ${scheme.accentGlow} ${scheme.border} ${className}`}
    >
      <div className="flex items-center justify-between">
        ...
        {Icon && (
          <div className={`w-11 h-11 rounded-2xl flex items-center justify-center ${scheme.bgIcon}`}>
      ...
      <div className="mt-3 flex items-center justify-between text-xs text-stone-500 dark:text-slate-400 pt-3 border-t border-stone-100 dark:border-slate-800">
