      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="fixed bottom-24 right-4 sm:right-6 z-50 w-[92vw] sm:w-[420px] max-h-[600px] h-[80vh] bg-slate-950 text-white rounded-3xl shadow-2xl border border-slate-800 overflow-hidden flex flex-col"
          >
            {/* Window Header */}
