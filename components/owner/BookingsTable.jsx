...
export default function BookingsTable() {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-stone-200/90 space-y-5">
      {/* Header & Controls */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h3 className="text-xl font-bold text-slate-900">Reservations & Stay Ledger</h3>
