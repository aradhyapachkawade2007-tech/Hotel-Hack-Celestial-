    ...
    >
          ...
          <div className="relative z-10 flex items-center gap-2 bg-white pr-3">
            <span
              className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${
                step >= 1 ? 'bg-amber-500 text-slate-950 shadow-md' : 'bg-stone-200 text-stone-600'
              }`}
            >
              1
            </span>
            <span className="text-xs font-semibold text-slate-800">Guest Information</span>
          </div>

          <div className="relative z-10 flex items-center gap-2 bg-white pl-3">
            <span
              className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${
                step >= 2 ? 'bg-amber-500 text-slate-950 shadow-md' : 'bg-stone-200 text-stone-600'
              }`}
            >
              2
            </span>
            <span className="text-xs font-semibold text-slate-800">Payment & Review</span>
          </div>
        </div>
      )}
      ...
      {step === 2 && (
        ...
        >
          ...
          <div className="bg-stone-50 rounded-2xl p-5 border border-stone-200/90 space-y-2.5">
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <Button
              ...
              variant="primary"
              size="lg"
              className="px-6 shadow-gold-glow"
            >
              {formData.paymentMethod === 'credit-card'
