...
export default function AuthModal({
  ...
  return (
    ...
    >
      <div className="bg-slate-950 text-white p-7 sm:p-8 relative overflow-hidden">
        ...
        {/* Role Pill Switcher */}
        <div className="bg-slate-900/90 p-1.5 rounded-2xl border border-slate-800 flex items-center gap-1 mb-6 relative z-10">
          <button
            type="button"
            onClick={() => {
              setActiveRole('guest');
