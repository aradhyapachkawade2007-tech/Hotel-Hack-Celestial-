        ...
        <div className="relative min-h-screen flex flex-col justify-between overflow-hidden bg-gradient-to-b from-stone-900 via-slate-950 to-slate-900 text-white">
          ...
          <header className="max-w-7xl mx-auto w-full px-6 py-8 flex items-center justify-between relative z-10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-amber-600 to-amber-300 text-slate-950 flex items-center justify-center font-serif font-black text-lg shadow-lg">
                LA
              </div>
              <div>
          ...
          <main className="max-w-5xl mx-auto w-full px-6 py-12 relative z-10 flex-1 flex flex-col justify-center">
            {/* Title Badge */}
            <motion.div
            ...
            >
              <span className="inline-flex items-center gap-2 text-xs uppercase font-bold tracking-widest text-amber-400 bg-amber-500/15 border border-amber-500/30 px-4 py-1.5 rounded-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                className="bg-slate-900/80 hover:bg-slate-900 backdrop-blur-xl border border-slate-800 hover:border-amber-500/50 rounded-3xl p-8 shadow-2xl transition-all duration-300 flex flex-col justify-between group cursor-pointer relative overflow-hidden"
              >
